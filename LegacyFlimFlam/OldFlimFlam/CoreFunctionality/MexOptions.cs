...
namespace MexInternals {
    ...
    public class MexOptions {
        ...
        private string m_iPAddressToBind;

        public string IPAddressToBind {
            get { return m_iPAddressToBind; }
            set { m_iPAddressToBind = value; }
        }
        ...
        private int m_portAddressToBind;

        public int PortAddressToBind {
            get { return m_portAddressToBind; }
            set { m_portAddressToBind = value; }
        }
        ...
        internal void LoadOptionsDefaults() {
            ...
            IPAddressToBind = Constants.DEFAULTIP_ADDRESS;
            PortAddressToBind = Constants.DEFAULTPORT_NUMBER;
