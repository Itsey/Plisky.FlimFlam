...
namespace MexInternals {
    ...
    internal class frmProcViewFilter : System.Windows.Forms.Form {
        ...
        internal bool FullRefreshRequired; // Defualt false
        ...
        private void cboQuickLoad_SelectedIndexChanged(object sender, EventArgs e) {
            ...
            if (File.Exists(filterName)) {
                ...
                MexCore.TheCore.ViewManager.AddUserNotificationMessageByIndex(ViewSupportManager.UserMessages.FilterFileNotFound, ViewSupportManager.UserMessageType.WarningMessage, filterName);
            }
        }
